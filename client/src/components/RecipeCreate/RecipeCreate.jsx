      ...
      {diets.length ? (
        <div>
          ...
          <div className={styles.containerFormAndTitle}>
            <div>
              <h1 className="titleCreate">
                <u>Create your recipe</u>
              </h1>
            </div>
            ...
            <form onSubmit={(e) => handleSubmit(e)}>
              <div>
                <label for="title">
                  <span className={styles.required}>Title:</span>
                </label>
                <input
              ...
              <div>
                <label for="summary">
                  <span className={styles.required}>Summary:</span>
                </label>
                <input
                  className={styles.inputForm}
                  type="text"
              ...
              <div>
                <label for="healthScore">
                  <span className={styles.required}>Health Score:</span>
                </label>
                <input
                  className={styles.inputForm}
                  type="number"
              ...
              <div>
                <label for="dishTypes">
                  <span className={styles.required}>Dish Types:</span>
                </label>
                <input
                  className={styles.inputForm}
                  type="text"
              ...
              <div>
                <label for="steps">
                  <span className={styles.required}>Steps:</span>
                </label>
                <input
                ...
                {diets.map((e) => {
                  return (
                    ...
                    <div className={styles.checkboxDiv}>
                      ...
                      />
                      <label className="labelCreate" htmlFor={e.id}>
                        {e.name}
                      </label>
                    </div>
                    // </li>
